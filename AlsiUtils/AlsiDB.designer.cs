...
namespace AlsiUtils
{
    ...
    partial void InsertOHLC_1_Hour(OHLC_1_Hour instance);
    partial void UpdateOHLC_1_Hour(OHLC_1_Hour instance);
    partial void DeleteOHLC_1_Hour(OHLC_1_Hour instance);
    #endregion

    public AlsiDBDataContext() :
        base(AlsiUtils.Data_Objects.GlobalObjects.CustomConnectionString, mappingSource)
    {
        OnCreated();
    }
		...
		public System.Data.Linq.Table<OHLC_1_Hour> OHLC_1_Hours
		{
			get
			{
				return this.GetTable<OHLC_1_Hour>();
			}
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.OHLC_Hour_1")]
		public int OHLC_Hour_1()
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
			return ((int)(result.ReturnValue));
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TradeHistory")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.OHLC_1_Hour")]
	public partial class OHLC_1_Hour : INotifyPropertyChanging, INotifyPropertyChanged
	{
