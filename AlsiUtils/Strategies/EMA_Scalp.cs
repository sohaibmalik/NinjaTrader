...
namespace AlsiUtils.Strategies
{
    public static class EMA_Scalp
    {
        ...
        private static List<EMA> A_2;
        private static List<EMA> A_3;
        private static List<EMA> A_4;
        private static List<EMA> A_5;
        private static List<EMA> A_6;

        private static List<EMA> B_1;
        private static List<EMA> B_2;
        private static List<EMA> B_3;
        private static List<EMA> B_4;
        private static List<EMA> B_5;
        ...
        public static void CalcTriggers(List<TradeStrategy> strategy, int x)
        {
            ...
            if (A_1[x - 1].Ema > B_1[x - 1].Ema && A_1[x].Ema < B_1[x].Ema
                )
            ...
            if (A_6[x - 1].Ema < E1[x - 1].Ema && A_6[x].Ema > B_1[x].Ema && A_6[x].Ema > E1[x].Ema
                || A_6[x - 1].Ema < B_1[x - 1].Ema && A_6[x].Ema > B_1[x].Ema && A_6[x].Ema > E1[x].Ema)
                strategy[x].TradeTrigger = TradeStrategy.Trigger.OpenLong;

            if (A_6[x - 1].Ema > E1[x - 1].Ema && A_6[x].Ema < E1[x].Ema && A_6[x].Ema < B_6[x].Ema
