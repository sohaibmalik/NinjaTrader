...
namespace ModernNotifier.Content
{
    /// <summary>
        ...
        public string SelectedFontSize
        {
            ...
            set
            {
                if (this.selectedFontSize != value)
                {
                    ...
                    Properties.Settings.Default.FontSize = value == FontLarge ? FontSize.Large : FontSize.Small;
                    Properties.Settings.Default.Save();
                }
            }
        }
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value)
                {
                    ...
                    AppearanceManager.Current.AccentColor = value;
                    Properties.Settings.Default.ForeColor_B = value.B;
                    Properties.Settings.Default.ForeColor_G = value.G;
                    Properties.Settings.Default.ForeColor_R = value.R;
                    Properties.Settings.Default.Save();
                }
            }
        }
