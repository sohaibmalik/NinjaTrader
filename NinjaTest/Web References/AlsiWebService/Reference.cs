...
namespace NinjaTest.AlsiWebService {
    using System;
    ...
    public partial class AlsiNotifyService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AlsiNotifyService() {
            this.Url = global::NinjaTest.Properties.Settings.Default.NinjaTest_AlsiWebService_AlsiNotifyService;
        ...
        /// <remarks/>
        public void InsertMessageAsync(string message) {
            this.InsertMessageAsync(message, null);
        }
        
        /// <remarks/>
        public void InsertMessageAsync(string message, object userState) {
