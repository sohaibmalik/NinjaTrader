...
namespace WebApplication1
{
    public partial class _Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string data = "";
            foreach (var d in dc.MasterMinutes.Where(z=>z.Stamp.Year==2013 && z.Stamp.Month==3 && z.Stamp.Day==20 && z.Stamp.Hour==17)) data += d.C.ToString() + ",";


        ;
            string title =  Request.QueryString["title"];
            string subtitle =  Request.QueryString["subtitle"];
            ...
            jstringb.Replace("%Title%", title);
            jstringb.Replace("%Subtitle%", subtitle);
