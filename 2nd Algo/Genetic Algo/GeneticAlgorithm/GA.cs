...
namespace BTL.generic
{
    ...
    public class GA
    {
        ...
        public GA(double crossoverRate, double mutationRate, int populationSize, int generationSize, int genomeSize, MaxMin MM)
        {
            InitialValues();
