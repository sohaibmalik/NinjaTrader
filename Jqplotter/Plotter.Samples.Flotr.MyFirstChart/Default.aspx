<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Flotr.MyFirstChart.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.Flotr.MyFirstChart</title>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                <asp:Flotr ID="Flotr" runat="server" Width="600px" Height="300px" EnableViewState="false">
                </asp:Flotr>
                <br />
