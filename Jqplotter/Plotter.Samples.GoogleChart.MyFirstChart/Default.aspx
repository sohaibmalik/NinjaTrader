<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.GoogleChart.MyFirstChart.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.GoogleChart.MyFirstChart</title>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                ...
                <br />
                <asp:Button ID="ButtonRedraw" runat="server" Text="Redraw" OnClick="ButtonRedraw_Click" Visible=false />
            </div>
        </form>
    </body>
</html>