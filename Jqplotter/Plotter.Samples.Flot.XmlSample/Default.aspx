<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Flot.XmlSample.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.Flot.XmlSample</title>
    ...
    <body>
        <form id="form1" runat="server">
            <div class="container">
                ...
                <asp:Flot ID="Flot" CssClass="flot" runat="server" EnableViewState="false" />
