<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.GoogleChart.XmlSample.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.GoogleChart.XmlSample</title>
    ...
    <body>
        <form id="form1" runat="server">
            <div class="container">
                ...
                <asp:GoogleChart ID="GoogleChart" CssClass="GoogleChart" runat="server" EnableViewState="false" />
