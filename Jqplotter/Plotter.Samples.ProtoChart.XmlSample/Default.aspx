<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.ProtoChart.XmlSample.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.ProtoChart.XmlSample</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="graph">
            <asp:ProtoChart ID="ProtoChart" runat="server" EnableViewState="false" Width="600px" Height="300px" />
        </div>
