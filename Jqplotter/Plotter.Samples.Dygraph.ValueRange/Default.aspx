<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Dygraph.ValueRange.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.Dygraph.ValueRange</title>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                <asp:Dygraph ID="Dygraph" runat="server" Width="600px" Height="300px" 
                              EnableViewState="false" YLowRange="-10" YHighRange="10">
                </asp:Dygraph>
