<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Flotr2.XmlSample.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.Flotr2.XmlSample</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="graph">
            <asp:Flotr2 ID="Flotr2" runat="server" EnableViewState="false" Width="600px" Height="300px" />
        </div>
