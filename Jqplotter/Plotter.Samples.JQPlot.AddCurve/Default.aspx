<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.JQPlot.AddCurve.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.JQPlot.AddCurve</title>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                <asp:JQPlot ID="JQPlot" runat="server" Width="600px" Height="300px" EnableAnimation="true">
                </asp:JQPlot>
                <br />
