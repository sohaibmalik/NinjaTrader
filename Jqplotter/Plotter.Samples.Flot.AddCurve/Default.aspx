<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Flot.AddCurve.Default"
...
<html>
    <!--
        ...
        -->
    <head runat="server">
        <title>Plotter.Samples.Flot.AddCurve</title>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                <asp:Flot ID="Flot" runat="server" Width="600px" Height="300px"></asp:Flot>
                <br />
