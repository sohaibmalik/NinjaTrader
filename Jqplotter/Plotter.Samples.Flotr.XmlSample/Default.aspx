<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Flotr.XmlSample.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.Flotr.XmlSample</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="graph">
            <asp:Flotr ID="Flotr" runat="server" EnableViewState="false" Width="600px" Height="300px" />
        </div>
