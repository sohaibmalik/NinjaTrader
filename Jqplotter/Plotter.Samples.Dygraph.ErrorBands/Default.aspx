<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Dygraph.ErrorBands.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.Dygraph.ErrorBands</title>
                ...
                <div class="settings">
                    ...
                    <div class="options">
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:CheckBox ID="CheckBoxAnimatedZooms" runat="server" Text="Animated Zooms" Checked="true"
