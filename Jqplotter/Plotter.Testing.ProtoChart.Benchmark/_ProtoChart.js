...
/*
* Modified by Akram El Assas
* Updated constructCanvas to add IE9 support and updated to Prototype 1.7
*
*/
...
Proto.Chart = Class.create({
    ...
    */
    constructCanvas: function () {
        ...
        this.canvas = new Element("CANVAS", { 'width': this.canvasWidth, 'height': this.canvasHeight });
        ...
        if (Prototype.Browser.IE && window.G_vmlCanvasManager) // excanvas hack
        {
        ...
        this.overlay = new Element("CANVAS", { 'width': this.canvasWidth, 'height': this.canvasHeight });
