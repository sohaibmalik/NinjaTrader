<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.Dygraph.MyFirstChart.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.Dygraph.MyFirstChart</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <asp:Dygraph ID="Dygraph" runat="server" Width="600px" Height="300px" EnableViewState="false"
            ShowRangeSelector="true" RangeSelectorPlotFillColor="Azure" RangeSelectorPlotStrokeColor="ActiveBorder">
        </asp:Dygraph>
