<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Plotter.Samples.JQPlot.Smooth.Default"
...
<!--
        ...
        -->
<head runat="server">
    <title>Plotter.Samples.JQPlot.Smooth</title>
...
<body>
    ...
    <div class="container">
        ...
        <asp:JQPlot ID="JQPlot" runat="server" EnableViewState="false" CssClass="jqPlot"
            Smooth="true" Fill="true" FillToZero="true" LegendPlacement="Outside" XAxisFormat="%F">
        </asp:JQPlot>
