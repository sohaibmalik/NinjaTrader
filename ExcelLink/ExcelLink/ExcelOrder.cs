...
namespace ExcelLink
{
    ...
    public class ExcelOrder
    {
        ...
        public xlTradeOrder ReadLastOrder()
        {
            ...
            Order.BS = (xlSheet.Cells[lastUsedRow, 2].Value == "B") ? xlTradeOrder.BuySell.Buy : xlTradeOrder.BuySell.Sell;
        ...
        public List<xlTradeOrder> ReadAllOrders()
        {
            ...
            for (int x = 2; x <= lastUsedRow; x++)
            {
                ...
                order.BS = (xlSheet.Cells[x, 2].Value == "B") ? xlTradeOrder.BuySell.Buy : xlTradeOrder.BuySell.Sell;
